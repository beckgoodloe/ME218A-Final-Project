...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "AlienSM.h"
// the name of the Init function
#define SERV_1_INIT InitAlienSM
// the name of the run function
#define SERV_1_RUN RunAlienSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "AirSM.h"
// the name of the Init function
#define SERV_2_INIT InitAirSM
// the name of the run function
#define SERV_2_RUN RunAirSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "FuelSM.h"
// the name of the Init function
#define SERV_3_INIT InitFuelSM
// the name of the run function
#define SERV_3_RUN RunFuelSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "MainGameSM.h"
// the name of the Init function
#define SERV_4_INIT InitMainGameSM
// the name of the run function
#define SERV_4_RUN RunMainGameSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "SoundboardSM.h"
// the name of the Init function
#define SERV_5_INIT InitSoundboardSM
// the name of the run function
#define SERV_5_RUN RunSoundboardSM
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4TOT, Check4FirestarterHit, Check4DialMove, Check4Alien1ButtonHit, Check4Alien2ButtonHit, Check4Alien3ButtonHit
...
#define TIMER0_RESP_FUNC PostMainGameSM
#define TIMER1_RESP_FUNC PostMainGameSM
#define TIMER2_RESP_FUNC PostMainGameSM
#define TIMER3_RESP_FUNC PostAlienSM
#define TIMER4_RESP_FUNC PostAirSM
#define TIMER5_RESP_FUNC PostFuelSM
#define TIMER6_RESP_FUNC PostMainGameSM
#define TIMER7_RESP_FUNC PostMainGameSM
#define TIMER8_RESP_FUNC PostMainGameSM
#define TIMER9_RESP_FUNC PostAirSM
#define TIMER10_RESP_FUNC PostSoundboardSM
#define TIMER11_RESP_FUNC PostFuelSM
...
#define KITCHEN_TIMER     0
#define SUCCESS_TIMER     1
#define GAMEOVER_TIMER    2
#define ALIEN_EVENT_TIMER 3
#define AIR_EVENT_TIMER   4
#define FUEL_EVENT_TIMER  5
#define ALIEN_FAIL_TIMER  6
#define AIR_FAIL_TIMER    7
#define FUEL_FAIL_TIMER   8
#define AIR_CHECK_TIMER   9
#define SOUNDBOARD_TIMER  10
#define BLINK_TIMER       11
